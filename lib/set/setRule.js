...
exports.default = setRule;

var _getStyleElement = _interopRequireDefault(require("./getStyleElement"));

var _insertRule = _interopRequireDefault(require("./insertRule"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function setRule(selector, rules, group, overwrite) {
  (0, _getStyleElement.default)(group, function (sheet) {
    if (sheet == null) {
      return;
    } else {
