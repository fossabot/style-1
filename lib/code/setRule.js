...
function _default(selector, declaration, group, overwrite) {
  (0, _getStyleSheet.default)(group, function (sheet) {
    if (sheet == null) {
      ...
      if (ruleIndex === -1) {
        (0, _insertRule.default)(sheet, selector, declaration);
      } else if (overwrite) {
        (0, _insertRule.default)(sheet, selector, declaration, ruleIndex);
      }
    }
  });
}
